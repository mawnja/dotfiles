...
--xx ::CocInstall coc-emmet #提高 HTML 和 CSS 编写效率的工具
--xx :CocInstall coc-git    # git 支持
...
---xx::CocInstall coc-vimlsp # lsp #与coc-jedi不能兼容
-- ::CocInstall coc-yaml   #专门用于增强 YAML 文件的编辑体验 
